...
const DashboardGrid = () => {
  const options = [
    ...
    { name: "Manage Capsules", icon: < Settings size={45} />, link: "manage-capsules" },
  ];
      ...
      <div className="flex flex-col  items-center justify-center gap-6">
        ...
        {options.map((option, index) => (
          <Link
            to={option.link}
            key={index}
            className="flex flex-col items-center w-1/2 justify-center border border-gray-300 rounded-lg p-6 hover:bg-gray-100 transition duration-300 shadow-md"
          >
